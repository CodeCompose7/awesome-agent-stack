...
`http://localhost:11434`. Tool-calling needs a local model that supports tools (e.g. `qwen3`); some models (e.g. `gemma`) emit tool calls as plain text and won't loop.
