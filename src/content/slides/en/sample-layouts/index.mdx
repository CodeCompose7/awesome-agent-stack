...
Tables use standard Markdown syntax. Hover a diagram or image for an **Enlarge** button, and press `o` for an overview of every slide. A long diagram scrolls inside its column with `aas-split scroll`.
