...
Instead of saying "I don't know," a model hands you a confident, plausible falsehood — and it slips by until a human checks each claim.

<details>
<summary>Concrete examples</summary>

- Invented citations and statistics, with no source
- Subtly wrong dates and numbers
- API or function names that don't exist

</details>

**Evaluation and tracing** close the gap.

- Score outputs automatically on faithfulness and accuracy
- Trace every step to find where it went wrong
- Let the pipeline catch regressions before your users do
